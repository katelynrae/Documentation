...
Youtube video: [https://www.youtube.com/watch?v=XzfE6j-LnII](https://www.youtube.com/watch?v=XzfE6j-LnII)
...
Architect - where you will design and build your interview protocol.

Network Canvas - An application which loads and administers interview protocols to study participants

Server - An application for researchers to manage the survey deployment process and their data
...
<p id="gdcalert1" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt0.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert2">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt0.png "image_tooltip")
...
#### <span style="text-decoration:underline;">Ontological Flexibility</span>
...
#### <span style="text-decoration:underline;">In-person and Interviewer-assisted</span>
...
#### <span style="text-decoration:underline;">Visualization</span>
...
<p id="gdcalert2" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt1.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert3">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt1.png "image_tooltip")



#### <span style="text-decoration:underline;">End-to-end Workflow</span>
...
#### <span style="text-decoration:underline;">Open-Source Development</span>
...
<p id="gdcalert3" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt2.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert4">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt2.png "image_tooltip")



### 1.4. Introduction to a Network Canvas Study
...
#### Public Health Demonstration Study:

Next, we will walk you through an example Network Canvas Protocol.
...
<p id="gdcalert4" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt3.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert5">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt3.png "image_tooltip")
...
<p id="gdcalert5" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt4.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert6">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt4.png "image_tooltip")
...
A timeline running along the left edge of the screen shows the progress through the interview. As we move forwards, the bar will fill up, and eventually turn green when we are finished.
Next (down arrow) and previous (up arrow) buttons, which can be used by the participant or by the researcher to advance the interview.
A settings menu in the top right.
```
...
Each interview is made up of what we call stages. Think of them as screens that your participant will see in sequence.
You can have as many stages in your interview as you feel you need, and as we will see later, there are many ways to structure your interview.
...
Ego Form is an interface which collects information about the Ego (the participant). The Ego Form is able to capture various types of data. 
```
...
Name Generators are interfaces which allow for the nomination of entities.
The name generator here allows detailed data to be collected about each person.
Within the Name Generator interface, Prompts are the text at the top which asks participants to nominate entities. Numerous prompts are can be used within a single Name Generator interface. 
Alters are added by clicking the Add Alter Button in the bottom right hand corner. 
```


[insert screenshot/s]

<p id="gdcalert6" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt5.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert7">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt5.png "image_tooltip")
...
<p id="gdcalert7" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt6.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert8">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt6.png "image_tooltip")
...
The Sociogram is an interface which allows participants to interact with the alters produced within the Name Generators. 
There are three common ways of interacting with alters: 1) Layout, where the participant spatially arranges the entities; 2) Create Edges, where the participant can create alter-alter edges; 3) Select, where the participant can select entities which meet a certain Boolean (T/F) criteria.
The background image shown on the Sociogram screen is very configurable. 
```
...
<p id="gdcalert8" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt7.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert9">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt7.png "image_tooltip")
...
<p id="gdcalert9" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt8.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert10">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt8.png "image_tooltip")
...
<p id="gdcalert10" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt9.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert11">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt9.png "image_tooltip")
...
Ordinal Bin is a configurable interface which allows you to drag entities into the bin that applies to them - ideal for ordinal data.  This interface greatly improves response burden of "matrix type" questions, where you ask the same question for each alter that has been nominated.
Categorical Bin is a configurable interface which allows you to drag entities into the bin that applies to them - ideal for categorical data. 
```


[insert screenshot]

<p id="gdcalert11" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt10.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert12">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt10.png "image_tooltip")


[insert screenshot]

<p id="gdcalert12" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt11.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert13">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt11.png "image_tooltip")


Now we find ourselves back on a name generator stage in order to show you a different way of nominating entities. Here, we use the “quick add” Name Generator, which only asks for a name. Creating an alter is as simple as clicking the button, typing a name, and pressing enter. When you are finished, either click the button, or click away, to close.

We are also using this screen to nominate a different type of alter (a restaurant). 


```
Key Concepts:

Name Generator (using quick add) is an interface which allows for the quick nomination of entities without asking for further details. 
...
<p id="gdcalert13" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt12.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert14">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt12.png "image_tooltip")
...
<p id="gdcalert14" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/2019-Sunbelt13.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert15">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/2019-Sunbelt13.png "image_tooltip")
